...
mixin _$TaskFormState {
 ...
 String get title; String get notes; TaskPriority get priority; DateTime? get dueDate; String? get dueTime; List<SubtaskFormItem> get subtaskItems; bool get hasEnabledReminder; bool get isRepeating; RecurrenceFrequency? get recurrenceFrequency; List<int> get recurrenceDaysOfWeek; bool get isSubmitting; bool get isSuccess; String? get error; Task? get initialTask; List<Goal> get availableGoals; String? get selectedGoalId; bool get isModified;
...
@override
int get hashCode => Object.hash(runtimeType,title,notes,priority,dueDate,dueTime,const DeepCollectionEquality().hash(subtaskItems),hasEnabledReminder,isRepeating,recurrenceFrequency,const DeepCollectionEquality().hash(recurrenceDaysOfWeek),isSubmitting,isSuccess,error,initialTask,const DeepCollectionEquality().hash(availableGoals),selectedGoalId,isModified);

@override
String toString() {
  return 'TaskFormState(title: $title, notes: $notes, priority: $priority, dueDate: $dueDate, dueTime: $dueTime, subtaskItems: $subtaskItems, hasEnabledReminder: $hasEnabledReminder, isRepeating: $isRepeating, recurrenceFrequency: $recurrenceFrequency, recurrenceDaysOfWeek: $recurrenceDaysOfWeek, isSubmitting: $isSubmitting, isSuccess: $isSuccess, error: $error, initialTask: $initialTask, availableGoals: $availableGoals, selectedGoalId: $selectedGoalId, isModified: $isModified)';
}
...
@useResult
$Res call({
 String title, String notes, TaskPriority priority, DateTime? dueDate, String? dueTime, List<SubtaskFormItem> subtaskItems, bool hasEnabledReminder, bool isRepeating, RecurrenceFrequency? recurrenceFrequency, List<int> recurrenceDaysOfWeek, bool isSubmitting, bool isSuccess, String? error, Task? initialTask, List<Goal> availableGoals, String? selectedGoalId, bool isModified
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String title,  String notes,  TaskPriority priority,  DateTime? dueDate,  String? dueTime,  List<SubtaskFormItem> subtaskItems,  bool hasEnabledReminder,  bool isRepeating,  RecurrenceFrequency? recurrenceFrequency,  List<int> recurrenceDaysOfWeek,  bool isSubmitting,  bool isSuccess,  String? error,  Task? initialTask,  List<Goal> availableGoals,  String? selectedGoalId,  bool isModified)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TaskFormState() when $default != null:
return $default(_that.title,_that.notes,_that.priority,_that.dueDate,_that.dueTime,_that.subtaskItems,_that.hasEnabledReminder,_that.isRepeating,_that.recurrenceFrequency,_that.recurrenceDaysOfWeek,_that.isSubmitting,_that.isSuccess,_that.error,_that.initialTask,_that.availableGoals,_that.selectedGoalId,_that.isModified);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String title,  String notes,  TaskPriority priority,  DateTime? dueDate,  String? dueTime,  List<SubtaskFormItem> subtaskItems,  bool hasEnabledReminder,  bool isRepeating,  RecurrenceFrequency? recurrenceFrequency,  List<int> recurrenceDaysOfWeek,  bool isSubmitting,  bool isSuccess,  String? error,  Task? initialTask,  List<Goal> availableGoals,  String? selectedGoalId,  bool isModified)  $default,) {final _that = this;
switch (_that) {
case _TaskFormState():
return $default(_that.title,_that.notes,_that.priority,_that.dueDate,_that.dueTime,_that.subtaskItems,_that.hasEnabledReminder,_that.isRepeating,_that.recurrenceFrequency,_that.recurrenceDaysOfWeek,_that.isSubmitting,_that.isSuccess,_that.error,_that.initialTask,_that.availableGoals,_that.selectedGoalId,_that.isModified);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String title,  String notes,  TaskPriority priority,  DateTime? dueDate,  String? dueTime,  List<SubtaskFormItem> subtaskItems,  bool hasEnabledReminder,  bool isRepeating,  RecurrenceFrequency? recurrenceFrequency,  List<int> recurrenceDaysOfWeek,  bool isSubmitting,  bool isSuccess,  String? error,  Task? initialTask,  List<Goal> availableGoals,  String? selectedGoalId,  bool isModified)?  $default,) {final _that = this;
switch (_that) {
case _TaskFormState() when $default != null:
return $default(_that.title,_that.notes,_that.priority,_that.dueDate,_that.dueTime,_that.subtaskItems,_that.hasEnabledReminder,_that.isRepeating,_that.recurrenceFrequency,_that.recurrenceDaysOfWeek,_that.isSubmitting,_that.isSuccess,_that.error,_that.initialTask,_that.availableGoals,_that.selectedGoalId,_that.isModified);case _:
  return null;
...
@override final  Task? initialTask;
 final  List<Goal> _availableGoals;
@override@JsonKey() List<Goal> get availableGoals {
  if (_availableGoals is EqualUnmodifiableListView) return _availableGoals;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_availableGoals);
}
...
@override
int get hashCode => Object.hash(runtimeType,title,notes,priority,dueDate,dueTime,const DeepCollectionEquality().hash(_subtaskItems),hasEnabledReminder,isRepeating,recurrenceFrequency,const DeepCollectionEquality().hash(_recurrenceDaysOfWeek),isSubmitting,isSuccess,error,initialTask,const DeepCollectionEquality().hash(_availableGoals),selectedGoalId,isModified);
