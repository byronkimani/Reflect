...
mixin _$Subtask {
 ...
 String get id; String get taskId; String get title; bool get isCompleted; int get sortOrder; DateTime get createdAt;
...
@override
String toString() {
  return 'Subtask(id: $id, taskId: $taskId, title: $title, isCompleted: $isCompleted, sortOrder: $sortOrder, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String id, String taskId, String title, bool isCompleted, int sortOrder, DateTime createdAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String taskId,  String title,  bool isCompleted,  int sortOrder,  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Subtask() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String taskId,  String title,  bool isCompleted,  int sortOrder,  DateTime createdAt)  $default,) {final _that = this;
switch (_that) {
case _Subtask():
return $default(_that.id,_that.taskId,_that.title,_that.isCompleted,_that.sortOrder,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String taskId,  String title,  bool isCompleted,  int sortOrder,  DateTime createdAt)?  $default,) {final _that = this;
switch (_that) {
case _Subtask() when $default != null:
return $default(_that.id,_that.taskId,_that.title,_that.isCompleted,_that.sortOrder,_that.createdAt);case _:
  return null;
...
class _Subtask implements Subtask {
  const _Subtask({required this.id, required this.taskId, required this.title, this.isCompleted = false, this.sortOrder = 0, required this.createdAt});
