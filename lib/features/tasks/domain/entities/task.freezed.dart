...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,title,priority,dueDate,dueTime,notes,const DeepCollectionEquality().hash(tags),status,isOverdue,overdueDay,recurrenceRule,recurrenceParentId,const DeepCollectionEquality().hash(subtasks),gcalEventId,syncToGcal,goalId,hasEnabledReminder,createdAt,updatedAt]);

@override
String toString() {
  return 'Task(id: $id, title: $title, priority: $priority, dueDate: $dueDate, dueTime: $dueTime, notes: $notes, tags: $tags, status: $status, isOverdue: $isOverdue, overdueDay: $overdueDay, recurrenceRule: $recurrenceRule, recurrenceParentId: $recurrenceParentId, subtasks: $subtasks, gcalEventId: $gcalEventId, syncToGcal: $syncToGcal, goalId: $goalId, hasEnabledReminder: $hasEnabledReminder, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String id, String title, TaskPriority priority, DateTime? dueDate, String? dueTime, String? notes, List<Tag> tags, TaskStatus status, bool isOverdue, int overdueDay, RecurrenceRule? recurrenceRule, String? recurrenceParentId, List<Subtask> subtasks, String? gcalEventId, bool syncToGcal, String? goalId, bool hasEnabledReminder, DateTime createdAt, DateTime updatedAt
});
...
as bool,goalId: freezed == goalId ? _self.goalId : goalId // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _Task() when $default != null:
return $default(_that.id,_that.title,_that.priority,_that.dueDate,_that.dueTime,_that.notes,_that.tags,_that.status,_that.isOverdue,_that.overdueDay,_that.recurrenceRule,_that.recurrenceParentId,_that.subtasks,_that.gcalEventId,_that.syncToGcal,_that.goalId,_that.hasEnabledReminder,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
class _Task extends Task {
  const _Task({required this.id, required this.title, this.priority = TaskPriority.p4, this.dueDate, this.dueTime, this.notes, final  List<Tag> tags = const [], this.status = TaskStatus.pending, this.isOverdue = false, this.overdueDay = 0, this.recurrenceRule, this.recurrenceParentId, final  List<Subtask> subtasks = const [], this.gcalEventId, this.syncToGcal = false, this.goalId, this.hasEnabledReminder = false, required this.createdAt, required this.updatedAt}): _tags = tags,_subtasks = subtasks,super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,title,priority,dueDate,dueTime,notes,const DeepCollectionEquality().hash(_tags),status,isOverdue,overdueDay,recurrenceRule,recurrenceParentId,const DeepCollectionEquality().hash(_subtasks),gcalEventId,syncToGcal,goalId,hasEnabledReminder,createdAt,updatedAt]);
